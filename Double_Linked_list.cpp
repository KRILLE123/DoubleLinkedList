...
struct LinkedList
{
    ...
    void Print() {
        ...
        int i = 0;
        while (current != nullptr) {
            cout << "Element: " << i << " Minnesplats: " << current << " Data: " << current->data_ << " Last: " << current->last << " Next: " << current->next << endl;
            current = current->next;
            i++;
        }
    }
...
int main()
{
    ...
    cout << "Första elementet är " << myLinkedList.GetFirst() << endl;
    cout << "Sista elementet är " << myLinkedList.GetLast() << endl;
    if (myLinkedList.Contains(20)) {
        cout << "Listan innehåller 20" << endl;
    }
    myLinkedList.Print();
}
